...
function ExerciseForm ({ setUserExerciseList }) {

    const { exerciseName, duration, intensity, isProcessing, handleTextOnChange, handleSaveBtnOnClick } = useExerciseForm({ setUserExerciseList })
